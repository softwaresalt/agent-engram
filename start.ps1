...
# Anchor the sidecar syncs to the repository directory so backlogit and engram
# resolve this workspace regardless of the caller's location. The current
# location is runspace state, so Push/Pop in a finally leaves the caller's
# PowerShell session location unchanged even when a sync throws.
