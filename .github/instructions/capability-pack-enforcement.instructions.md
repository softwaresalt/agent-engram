---
description: "Capability-pack usage-enforcement coordinator — cross-pack retrieval routing, precedence, exemptions, and sensitivity-aware fallback for retrieval-enforced packs (agent-engram)"
applyTo: '**'
---
