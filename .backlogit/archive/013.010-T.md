---
artifact_type: task
created_at: 2026-04-13T18:39:56.1721491-07:00
custom_fields:
    backlog_md_created_date: 2026-03-26 00:44
    backlog_md_id: TASK-009.10
    backlog_md_parent_task_id: TASK-009
    backlog_md_priority: high
    backlog_md_source_path: .backlog/completed/task-009.10 - BUG-unified_search-fails-with-error-5001-—-NaN-float-deserialization-in-embedding-vectors.md
    backlog_md_type: bug
id: 013.010-T
labels:
    - bug
...
priority: medium
references:
    - src/db/queries.rs (hybrid_graph_vector_search, list_symbols, upsert_content_record)
    - src/services/embedding.rs
    - src/db/schema.rs (embedding vector field definitions)
status: done
title: 'BUG: unified_search fails with error 5001 — NaN float deserialization in embedding vectors'
updated_at: 2026-04-13T18:39:56.1721491-07:00
---
