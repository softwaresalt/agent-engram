---
artifact_type: task
created_at: 2026-04-13T18:39:55.2881501-07:00
custom_fields:
    backlog_md_created_date: 2026-03-25 05:22
    backlog_md_id: TASK-009.09
    backlog_md_implementationNotes: 'Harness: `cargo test --test integration_file_hash_pipeline` — S085, S086, S087 are RED gates; S088 is a GREEN guard. S085 asserts detect_offline_changes returns empty set for src/ files after index_workspace. S086 asserts file_hash table contains a record for each indexed file. S087 asserts re-indexing unchanged files leaves change set empty. Implement by calling `record_file_hash` inside `index_workspace_inner` in `src/tools/write.rs` after each successful file upsert.'
    backlog_md_parent_task_id: TASK-009
    backlog_md_priority: medium
    backlog_md_source_path: .backlog/completed/task-009.09 - Wire-record_file_hash-into-indexing-and-watcher-pipeline.md
...
updated_at: 2026-04-13T18:39:55.2881501-07:00
---
